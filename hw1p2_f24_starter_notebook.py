...
train_data = AudioDataset("/content/11785-f24-hw1p2", PHONEMES, config['context'], 'train-clean-100')

# TODO: Create a dataset object using the AudioDataset class for the validation data
val_data = AudioDataset("/content/11785-f24-hw1p2", PHONEMES, config['context'], 'dev-clean')

# TODO: Create a dataset object using the AudioTestDataset class for the test data
test_data = AudioTestDataset("/content/11785-f24-hw1p2", config['context'], 'test-clean')
