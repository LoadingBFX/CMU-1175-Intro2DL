...
def prepare_data(config: dict, tokenizer: GTokenizer):
    ...
    return val_loader, test_loader, 4370, 517
...
def main():
    ...
    levenshtein_distance, _, wer, cer = validate_step(
        model, val_loader, tokenizer, device, mode='full', threshold=None
    )
...
if __name__ == "__main__":
    checkpoint_path = "./dec_cond_lm_fbank_Transformer_ENC-9-16_DEC-8-16_512_2048_AdamW_CosineAnnealing_token_char/checkpoints/checkpoint-best-loss-modelfull.pth"
    main()
